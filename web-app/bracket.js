  ...
  semifinals: [
    {
      seed1: 1, gm1: 'Andy', team1: 'Birth2Girth',
      seed2: 6, gm2: 'Adam', team2: 'SpudKick',
      winner: 1, score1: 105.50, score2: 62.70,
      players1: [
        { name: 'Brayden Point',    fp: 6.00  },
        { name: 'Morgan Geekie',    fp: 2.00  },
        { name: 'Dylan Guenther',   fp: 9.50  },
        { name: 'Jason Robertson',  fp: 18.50 },
        { name: 'Gabe Perreault',   fp: 0.00  },
        { name: 'Troy Terry',       fp: 4.00  },
        { name: "K'Andre Miller",   fp: -2.50 },
        { name: 'Lane Hutson',      fp: 14.00 },
        { name: 'Brock Faber',      fp: 5.50  },
        { name: 'Sam Malinski',     fp: 10.00 },
        { name: 'Jimmy Snuggerud',  fp: 4.00  },
        { name: 'Gabriel Landeskog',fp: -3.00 },
        { name: 'Brady Tkachuk',    fp: 13.00 },
        { name: 'Matthew Knies',    fp: 1.00  },
        { name: 'Nikita Kucherov',  fp: 6.00  },
        { name: 'Dylan Cozens',     fp: 0.50  },
        { name: 'Ilya Sorokin',     fp: 11.20 },
        { name: 'Jake Oettinger',   fp: 1.90  },
        { name: 'Lukas Dostal',     fp: 3.90  },
      ],
      players2: [
        { name: 'Ryan McLeod',          fp: -5.00  },
        { name: 'Rickard Rakell',       fp: 10.00  },
        { name: 'Ryan Nugent-Hopkins',  fp: 7.00   },
        { name: 'Jason Zucker',         fp: -2.00  },
        { name: 'Bryan Rust',           fp: 0.50   },
        { name: 'Nikolaj Ehlers',       fp: 8.50   },
        { name: 'Dougie Hamilton',      fp: 10.50  },
        { name: 'MacKenzie Weegar',     fp: 5.50   },
        { name: 'Jake Sanderson',       fp: 0.00   },
        { name: 'Simon Edvinsson',      fp: 0.00   },
        { name: 'Zach Benson',          fp: -1.00  },
        { name: 'Patrick Kane',         fp: 6.00   },
        { name: 'Roope Hintz',          fp: 0.00   },
        { name: 'Robert Thomas',        fp: 2.00   },
        { name: 'Josh Doan',            fp: -1.00  },
        { name: 'Travis Sanheim',       fp: -1.00  },
        { name: 'Ridly Greig',          fp: 0.00   },
        { name: 'Brock Boeser',         fp: -2.00  },
        { name: 'Jonathan Marchessault',fp: -1.00  },
        { name: 'Vladislav Gavrikov',   fp: 1.00   },
        { name: 'Matias Maccelli',      fp: 5.00   },
        { name: 'Damon Severson',       fp: 4.00   },
        { name: 'Shane Pinto',          fp: 4.00   },
        { name: 'Karel Vejmelka',       fp: 2.20   },
        { name: 'Linus Ullmark',        fp: 9.50   },
        { name: 'Akira Schmid',         fp: 0.00   },
        { name: 'Thatcher Demko',       fp: 0.00   },
      ],
    },
    {
      seed1: 2, gm1: 'Bimm', team1: 'Killin me Scheifle',
      seed2: 5, gm2: 'Mike', team2: 'Shit The Driveway',
      winner: 1, score1: 118.30, score2: 69.40,
      players1: [
        { name: 'Bo Horvat',             fp: 6.00  },
        { name: 'Jamie Benn',            fp: 0.00  },
        { name: 'Filip Forsberg',        fp: 15.00 },
        { name: 'Juraj Slafkovsky',      fp: 15.50 },
        { name: 'Gabriel Vilardi',       fp: 13.50 },
        { name: 'Mats Zuccarello',       fp: 3.00  },
        { name: 'Rasmus Dahlin',         fp: 5.50  },
        { name: 'Darren Raddysh',        fp: 15.50 },
        { name: 'Josh Morrissey',        fp: 9.00  },
        { name: 'Nikita Zadorov',        fp: -1.00 },
        { name: 'Brandon Hagel',         fp: 20.50 },
        { name: 'Mitch Marner',          fp: 3.50  },
        { name: 'Drake Batherson',       fp: -0.50 },
        { name: 'Carter Yakemchuk',      fp: -1.50 },
        { name: 'Tyler Kleven',          fp: 1.00  },
        { name: 'Sean Walker',           fp: -1.50 },
        { name: 'Brandon Bussi',         fp: 3.40  },
        { name: 'Spencer Knight',        fp: 6.90  },
        { name: 'Ukko-Pekka Luukkonen',  fp: 5.80  },
        { name: 'John Gibson',           fp: 4.70  },
      ],
      players2: [
        { name: 'Steven Stamkos',       fp: 10.00 },
        { name: 'Sebastian Aho',        fp: 4.50  },
        { name: 'Kirill Kaprizov',      fp: 2.00  },
        { name: 'Mikko Rantanen',       fp: -0.50 },
        { name: 'Andrei Svechnikov',    fp: 4.50  },
        { name: 'Connor Bedard',        fp: 2.00  },
        { name: 'Mike Matheson',        fp: 4.00  },
        { name: 'Cale Makar',           fp: 2.00  },
        { name: 'Mattias Samuelsson',   fp: -3.00 },
        { name: 'Roman Josi',           fp: 1.00  },
        { name: 'Mika Zibanejad',       fp: 7.50  },
        { name: 'Cutter Gauthier',      fp: 6.00  },
        { name: 'Nick Schmaltz',        fp: 2.00  },
        { name: 'Jakob Chychrun',       fp: 7.50  },
        { name: 'Valeri Nichushkin',     fp: 1.50  },
        { name: 'Andrei Vasilevskiy',   fp: 5.10  },
        { name: 'Jeremy Swayman',       fp: 9.10  },
        { name: 'Logan Thompson',       fp: 4.20  },
      ],
    },
  ],
  final: {
    gm1: null, team1: null, seed1: null,
    gm2: null, team2: null, seed2: null,
    winner: 1, score1: 122.95, score2: 116.40,
    players1: [
      { name: 'Morgan Geekie',     fp: 3.00  },
      { name: 'Dylan Cozens',      fp: 8.00  },
      { name: 'Brady Tkachuk',     fp: 10.75 },
      { name: 'Gabriel Landeskog', fp: 11.50 },
      { name: 'Jimmy Snuggerud',   fp: 11.50 },
      { name: 'Dawson Mercer',     fp: 0.00  },
      { name: 'Lane Hutson',       fp: 5.50  },
      { name: 'Brock Faber',       fp: 4.00  },
      { name: 'Sam Malinski',      fp: 15.00 },
      { name: 'Kris Letang',       fp: 0.50  },
      { name: 'Brayden Point',     fp: 4.00  },
      { name: 'Nikita Kucherov',   fp: 12.00 },
      { name: 'Matthew Knies',     fp: 1.50  },
      { name: 'Jason Robertson',   fp: 1.00  },
      { name: 'Troy Terry',        fp: 6.50  },
      { name: "K'Andre Miller",    fp: 10.00 },
      { name: 'Dylan Guenther',    fp: 17.00 },
      { name: 'Jordan Kyrou',      fp: 3.00  },
      { name: 'Jacob Fowler',      fp: 0.40  },
      { name: 'Ilya Sorokin',      fp: -6.20 },
      { name: 'Jake Oettinger',    fp: 11.00 },
      { name: 'Lukas Dostal',      fp: -7.00 },
    ],
    players2: [
      { name: 'Ryan Hartman',            fp: 5.00  },
      { name: 'Logan Stankoven',         fp: 3.00  },
      { name: 'Juraj Slafkovsky',        fp: 11.00 },
      { name: 'Drake Batherson',         fp: 5.00  },
      { name: 'Mats Zuccarello',         fp: 17.00 },
      { name: 'Valeri Nichushkin',        fp: 0.00  },
      { name: 'Philip Broberg',          fp: 13.50 },
      { name: 'Jordan Spence',           fp: 0.50  },
      { name: 'Josh Manson',             fp: 0.50  },
      { name: 'Cole Hutson',             fp: -4.00 },
      { name: 'Egor Chinakhov',          fp: 6.00  },
      { name: 'Rasmus Dahlin',           fp: 5.00  },
      { name: 'Mitch Marner',            fp: 19.00 },
      { name: 'Brandon Hagel',           fp: -3.00 },
      { name: 'Josh Morrissey',          fp: 7.00  },
      { name: 'Tyson Foerster',          fp: 0.00  },
      { name: 'Jamie Benn',              fp: 3.50  },
      { name: 'Alexander Wennberg',      fp: 9.50  },
      { name: 'Bo Horvat',               fp: 4.00  },
      { name: 'Darren Raddysh',          fp: 7.50  },
      { name: 'Gabriel Vilardi',         fp: -2.00 },
      { name: 'Filip Forsberg',          fp: 12.00 },
      { name: 'Mikael Granlund',         fp: -1.00 },
      { name: 'Charlie Lindgren',        fp: -7.20 },
      { name: 'Joonas Korpisalo',        fp: 2.80  },
      { name: 'John Gibson',             fp: 2.80  },
      { name: 'Ukko-Pekka Luukkonen',    fp: 1.00  },
      { name: 'Spencer Knight',          fp: -2.00 },
    ],
  },
  champion: null,
};
